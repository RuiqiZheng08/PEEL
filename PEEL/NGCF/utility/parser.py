...
def parse_args():
    ...
    parser.add_argument('--dataset', nargs='?', default='amazon-book',
                        help='Choose a dataset from {gowalla, yelp2020, amazon-book, amazon-book-sample}')
    ...
    parser.add_argument('--num_blocks_per', type=int, default=16,
                        help='Max number of blocks per item.')
    ...
    parser.add_argument('--node_dropout_flag', type=int, default=7,
    ...
    parser.add_argument('--Ks', nargs='?', default='[20, 40, 50, 80, 100]',
                        help='Output sizes of every layer')
