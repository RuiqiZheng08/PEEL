...
def map_features():
	...
	features = {}
	#
	features = read_features('data/'+config.dataset+'/train.txt', features)
	features = read_features('data/'+config.dataset+'/valid.txt', features)
	features = read_features('data/'+config.dataset+'/test.txt', features)
